...
class PotentialCouple(LordGods):
    def __init__(self, **kwargs):
        ...
        self.position_relationship_mapping = {
            "年柱": "婚恋对象年龄较大，大约在一旬左右甚至以上;距离较远，有可能不是当地的或同城的;也有可能是上司或老板等。",
            "月柱": "婚恋对象年龄稍大，大约在半旬左右甚至以上;距离稍近，有可能是当地或同城的熟人、同学、朋友等。",
            "日柱": "婚恋对象年龄相仿，大约在两三岁或是同龄人;也有可能稍小;距离很近，有可能是经常接触的熟人朋友等。",
            "时柱": "婚恋对象年龄较小，有可能相差半旬左右或以上;距稍远，也有可能是熟人朋友或下属等。",
        }
