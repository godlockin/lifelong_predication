...
class LordGodsStructure(LordGods):
    ...
    def calc_structure(self):
        yue_zhi_lord_gods = [item[2] for item in self.yue_zhi_lord_gods]
    ...
    def calc_structure_expansion(self):
        conditions = {
            '正财': {
                'comment': '正财：纯物质型十神。重现实、讲实际、脚踏实地、诚实可信。',
            ...
            '偏财': {
                'comment': '偏财：偏向于物质型十神，其本性偏向于吉神。偏财之人深谙理财处事的诀窍，头脑灵活，多才多艺，为人处事圆滑干练；豪爽仗义，注重物质的享受。',
            ...
            '正官': {
                'comment': '正官：物质型十神，是最理想的十神。习惯在法律、法规、社会习俗、规章制度允许的前提下求名、求发展。',
            ...
            '偏官': {
                'comment': '物质型十神。名声、地位是七杀之人终生的追求，他们能为名利舍弃一切，包括家庭、生命。',
            ...
            '正印': {
                'comment': '正印：纯精神型十神。淡泊名利、注重荣誉、好学多思、博爱无私。',
            ...
            '偏印': {
                'comment': '偏印：精神型十神。思想怪异，深具创造力。精明能干，缺少人情味。',
            ...
            '食神': {
                'comment': '食神：精神型十神。聪明仁慈、通情达理、乐于奉献。',
            ...
            '伤官': {
                'comment': '伤官：精神和物质矛盾型十神。才华横溢，大胆泼辣，斗志昂扬，狂傲乖张。刚愎自用，言语尖锐，气量狭小。',
            ...
            '比肩': {
                'comment': '比肩：物质型十神。其本性偏，向于凶神。比肩之人自信自尊，好攀比，不服输，有自知之明。',
            ...
            '劫财': {
                'comment': '劫财：物质型十神。自信、武断，斗志高昂，以行动解决问题；投机取巧，野心勃勃；人不犯我，我也犯人。',
