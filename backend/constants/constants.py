...
BASE_DATE = datetime(1900, 1, 31, 0, 0, 0).astimezone(pytz.timezone('Asia/Shanghai'))
...
GAN_MATRIX = [
    ...
    ["丙", "南", "阳", "火", "红", "小肠", "额", "太阳/圆形物品", "太阳火",
     "有光明天地之功，其性猛烈，欺雪侮霜，普照万物，故为阳火。", ],
    ["丁", "南", "阴", "火", "红", "心脏/血液", "齿舌", "蜡烛、灯泡、烟头", "太阴火",
     "有明照千家万户之功，其性柔质弱，为人不为己，故为阴火。", ],
    ["戊", "中间", "阳", "土", "黄", "胃", "鼻", "城墙土", "城垣之土",
     "为万物司令，其性高亢质，硬而向阳，生育万物，故为阳土。", ],
    ["己", "中间", "阴", "土", "黄", "脾", "面", "田地", "田园之土",
     "有培木止水之能。其性湿质软，低洼向阴，造福人间，故为阴土。", ],
    ["庚", "西", "阳", "金", "白/金", "大肠", "筋", "宝剑、大刀、汽车", "剑戟",
     "有刚健肃杀之力。其性刚质硬，肃杀万物，故为阳金。", ],
    ["辛", "西", "阴", "金", "白/金", "肺", "胸", "首饰、小型金属饰品", "珠玉",
     "有镶嵌珠宝之用。其性温柔，质温清韵，装饰人间，故为阴金。", ],
    ["壬", "北", "阳", "水", "黑/蓝", "膀胱", "胫", "(大水)江河湖海", "江、河、湖、海",
     "通天河而周流不息，其性猛质硬，灌溉万物，故为阳水。", ],
    ["癸", "北", "阴", "水", "黑/蓝", "肾", "足", "(小水)溪、井、小河、露水、下水道", "雨露之水",
     "润物无声，其性柔质软，润泽万物，故为阴水。", ]
]
GAN_DETAILS = {line[0]: {
    "gan": line[0],
    "direction": line[1],
...
LIFE_WEIGHT_MAPPING = {
    "2.1": "短命非业谓大凶，平生灾难事重重，凶祸频临限逆境，终世困苦事不成",
...
LIFE_WEIGHT_YEAR_RATIO = {
    '壬申': 0.7, '乙亥': 0.9, '己巳': 0.5,
...
LIFE_WEIGHT_MONTH_RATIO = {
    '11': 0.9, '10': 0.8, '12': 0.5, '1': 0.6, '3': 1.8, '2': 0.7, '5': 0.5, '4': 0.9, '7': 0.9,
    '6': 1.6,
    '9': 1.8, '8': 1.5
}

LIFE_WEIGHT_DAY_RATIO = {
    '24': 0.9, '25': 1.5, '26': 1.8, '27': 0.7, '20': 1.5, '21': 1, '22': 0.9, '23': 0.8,
    '28': 0.8, '29': 1.6,
...
LIFE_WEIGHT_HOUR_RATIO = {
    '24': 1.6, '20': 0.6, '21': 0.6, '22': 0.6, '23': 1.6, '1': 0.6, '3': 0.7, '2': 0.6, '5': 1,
    '4': 0.7, '7': 0.9,
...
LIFE_PREDICTION_LABELS = {
    ...
    'zodiac_explain': '生肖',
    'lord_gods': '十神',
    'lord_gods_structure': '命格',
    'finance_storage': '财库',
    'demigods': '神煞',
    'family_support': '家庭关系',
    'life_stages_luck': '人生阶段',
    'nine_stars': '九星',
    'ten_years_luck': '大运',
    'yearly_luck': '流年',
    'intermarriage': '合婚',
    'potential_couple': '潜在对象',
}
