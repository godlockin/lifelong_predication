...
class JieSha(DemigodExplain):
    def __init__(self, demigods, lord_gods):
        ...
        八字中有两个及以上的劫煞的，命主有暴力倾向，天不怕地不怕，天生犯罪意识反社会，可能成为强盗、偷窃等。
        劫煞与贵星同柱：谋事有成。
...
class XueRen(DemigodExplain):
    ...
    3、若羊刃、血刃、多同柱
    因车祸导致流血，不论开车还是外出旅游，都必须十分小心。若条件允许的话，不妨给自己买一份意外人身保险。
    4、血刃过多
    八字中有一个以上的血刃者，遇到血光之灾的机率会大大增加。故命带血刃多，又无天月德贵人解救或有正印贴身保护的话，容易横死
    5、女同志命带血刃
    易有产厄、血崩之灾，生产时必须注意大量流血的事情发生
        """
...
class HongYan(DemigodExplain):
    def __init__(self, demigods, lord_gods):
        ...
        女命见之，难免私情，一谈恋爱可能就会陷入同居生活，如果地支有日干的禄，又带驿马，为生理欲望较强之人。
        """
